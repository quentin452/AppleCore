...
public class SyncHandler {
    ...
    public void onLivingUpdateEvent(LivingUpdateEvent event) {
        ...
        if (lastSaturationLevel == null
                || lastSaturationLevel != player.getFoodStats().getSaturationLevel()) {
    ...
    public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        channel.sendTo(
                new MessageDifficultySync(event.player.worldObj.difficultySetting), (EntityPlayerMP) event.player);
    }
